...
2. **Show search algorithms doing real work** (AI: A Modern Approach):
   ...
   - **Belief states** guess the hidden tyre wear of rival cars from their lap times.
...
sim/                the race and the agents (no web code)
  ...
  strategist.py     strategist agent: A* plans, belief states, minimax duels
  search.py         A* / UCS, minimax with alpha-beta, belief-state update
