...
def main():
    ...
    model = {
        ...
        "tyres": {
            ...
            "WET": {"offset_s": 0.0, "wear_s_per_lap": round(medium_wear * SCALE, 3), "life_laps": 15, "source": "hand",
        ...
        "rain": {"dry_tyre_s_at_full_rain": 12.0, "wet_tyre_s_when_dry": 3.0, "wet_tyre_s_at_full_rain": 2.0, "source": "hand",
                 "note": "the real race was dry; seconds added per lap, scaled by rain level 0 (dry) to 1 (heaviest)"},
